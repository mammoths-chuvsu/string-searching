...
Below is your text with improved spacing for the tables. I have not changed any values, only added spaces for clarity.
...
| Suffix array   | 1181              | 17.19             | 767          | 17.53        | 2320       | 17.39      |
...
| Suffix array   | 5361              | 10.45             | 816          | 17.52        | 1985       | 18.28      |
...
| Suffix array   | 5349              | 10.45             | 353          | 9.84         | 872        | 9.97       |
...
| Suffix array   | 10524             | 17.16             | 183          | 17.26        | 840        | 9.47       |
...
| Suffix array   | 5354              | 10.46             | -            | -            | 832        | 9.64       |
...
| Suffix array   | 5354              | 10.46             | 353          | 9.84         | 832        | 9.64       |
...
| Suffix array   | 11787             | 17.19             | 339          | 9.83         | 911        | 9.47       |
...
- **Suffix array** показал себя медленным, особенно при отсутствии подстроки.

- **Suffix Tree** значительно быстрее, чем суффиксный массив, но требует очень много памяти.

- **Boyer-Moore** является самым быстрым среди алгоритмов, когда подстрока присутствует, но его эффективность резко снижается, если подстрока отсутствует.
...
- **Suffix array**/**Suffix Tree** – для многократного поиска.

- **Boyer-Moore** – для быстрого разового поиска в больших текстах.
